    ...
    return function e(t, n, r) {
        ...
        10: [function(t, e) {
            ...
            function n(t, e) {
                ...
                this.ir.once("finish", function(t, e) {
                    n.ir = null,
                    n.emit("message", o.stringify([t, e]))
                })
            }
            var r = t("inherits")
        ...
        11: [function(t, e) {
            (function(n) {
                ...
                function r(t) {
                    ...
                    i.call(this);
                    var r = function() {
                        var n = e.ifr = new u(l.transportName,t,t);
                    ...
                    n.document.body ? r() : a.attachEvent("load", r)
                }
        ...
        12: [function(t, e) {
            ...
            var r = t("events").EventEmitter
              ...
              , f = t("./info-ajax");
            i(n, r),
            n._getReceiver = function(t, e) {
                return e.sameOrigin ? new f(t,u) : a.enabled ? new f(t,a) : s.enabled && e.sameScheme ? new f(t,s) : c.enabled() ? new c(t) : new f(t,l)
            }
            ,
            n.prototype.doXhr = function(t, e) {
                var r = this
                  , i = o.addPath(t, "/info");
                this.xo = n._getReceiver(i, e),
        ...
        14: [function(t, e) {
            (function(n) {
                ...
                function r(t, e, n) {
                    ...
                    var o = "https:" === i.protocol;
                    if ("https" === g.protocol && !o)
                ...
                r.prototype._connect = function() {
                    for (var t = this._transports.shift(); t; t = this._transports.shift()) {
                        ...
                        var r = f.addPath(this._transUrl, "/" + this._server + "/" + l.string(8))
        ...
        46: [function(t, e) {
            (function(n) {
                ...
                e.exports.attachEvent("unload", s)
            }
            ).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        }
        , {
                ...
                e.exports = {
                    ...
                    createIframe: function(t, e) {
                        var i, o, s = n.document.createElement("iframe"), a = function() {
                            ...
                            try {
                                s && s.contentWindow && setTimeout(function() {
                    ...
                    createHtmlfile: function(t, i) {
                        var o, s, a, u = ["Active"].concat("Object").join("X"), l = new n[u]("htmlfile"), c = function() {
                            ...
                            try {
                                a && a.contentWindow && setTimeout(function() {
